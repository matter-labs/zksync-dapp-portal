...
Feature: Artifacts - UI
  ...
  Scenario: Check artifacts on the Contacts page
    ...
    When I fill the element of "placeholder" with "Name of the contact" value by "My second contact"
  ...
  Scenario Outline: Check error for the <An incorrect address value> wrong account address on the Contacts page
    ...
    When I fill the element of "placeholder" with "Name of the contact" value by "Test"
    When I fill the element of "placeholder" with "Ethereum address" value by "<An incorrect address value>"
