...
Feature: Artifacts - UI
  ...
  Scenario: Check artifacts on the Approve allowance modal - Deposits
    ...
    Then Element with "xpath" "//*[@class='modal-card']//*[contains(text(),'Learn more')]" should be "visible"
    Then Element with "xpath" "//*[@class='modal-card']//*[contains(text(),'Learn more')]" should be "clickable"
