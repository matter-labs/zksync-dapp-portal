...
Feature: Artifacts - UI - Swap
  ...
  Scenario: Check artifacts for the Swap page
    ...
    Then Element with "src" "/img/mute.svg" should be "visible"
    Then Element with "src" "/img/mute.svg" should be "clickable"
    ...
    Then Element with "src" "/img/maverick-protocol.svg" should be "visible"
    Then Element with "src" "/img/maverick-protocol.svg" should be "clickable"
    ...
    Then Element with "src" "/img/izumi.svg" should be "visible"
    Then Element with "src" "/img/izumi.svg" should be "clickable"
    ...
    Then Element with "src" "/img/velocore.svg" should be "visible"
    Then Element with "src" "/img/velocore.svg" should be "clickable"
    ...
    Then Element with "src" "/img/syncswap.svg" should be "visible"
    Then Element with "src" "/img/syncswap.svg" should be "clickable"
    ...
    Then Element with "src" "/img/spacefi.svg" should be "visible"
    Then Element with "src" "/img/spacefi.svg" should be "clickable"
    ...
    Then Element with "src" "/img/ezkalibur.svg" should be "visible"
    Then Element with "src" "/img/ezkalibur.svg" should be "clickable"
    ...
    Then Element with "src" "/img/vesync.svg" should be "visible"
    Then Element with "src" "/img/vesync.svg" should be "clickable"